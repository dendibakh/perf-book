...
\newtcolorbox{gazquote}{colback=red!7!white,grow to right by=-10mm,grow to left by=-10mm, boxrule=0pt,boxsep=0pt,breakable}
\newcommand{\highlight}[1]{\begin{gazquote} \textbf{Characterization highlights.} #1 \end{gazquote}}
