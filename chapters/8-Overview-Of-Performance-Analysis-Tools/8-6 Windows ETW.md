...
In the screenshot @fig:ETWController_WPA, hte top portion displays the double-click event as it is saved by ETWController. The lower portion shows the recorded ETW data opened in Windows Performance Analyzer (WPA).
