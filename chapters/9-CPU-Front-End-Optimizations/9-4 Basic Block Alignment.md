...
![default layout](../../img/mt-perf/LoopAlignment_Default.png){#fig:Loop_default width=90%}

![improved layout](../../img/mt-perf/LoopAlignment_Better.png){#fig:Loop_better width=90%}
