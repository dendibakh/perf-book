...
[^2]: When the value of PMCs overflows, the execution of a program must be interrupted. Software then should save the fact of an overflow. We will discuss it in more details later.
