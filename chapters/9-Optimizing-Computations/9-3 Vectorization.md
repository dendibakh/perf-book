...
[TODO]: Add examples of SIMD and scalar code in both x86 and ARM. Often people conclude from seeing xmm0 and vmulss that the code must have been vectorized, and not realizing that it is just scalar code.
