...
![MESI States Diagram. *© Image by University of Washington via courses.cs.washington.edu.*](/5/MESI_Cache_Diagram.jpg){#fig:MESI width=60%}
...
![False Sharing: two threads access the same cache line. *© Image by Intel Developer Zone via software.intel.com.*](/5/FalseSharing.jpg){#fig:FalseSharing width=50%}
