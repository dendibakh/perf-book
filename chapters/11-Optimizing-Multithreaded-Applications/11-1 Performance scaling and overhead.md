...
![The theoretical speedup of the latency of the execution of a program as a function of the number of processors executing it, according to Amdahl's law. *© Image by Daniels220 via Wikipedia.*](/5/AmdahlsLaw.png){#fig:MT_AmdahlsLaw width=70%}
...
![Performance scaling with different number of threads.](/5/scaling.png){#fig:MT_Scaling width=45%}
![Overhead of using different number of threads.](/5/cycles.png){#fig:MT_cycles width=45%}
...
![Universal Scalability Law and Amdahl's law. *© Image by Neha Bhardwaj via [Knoldus Blogs](https://blog.knoldus.com/understanding-laws-of-scalability-and-the-effects-on-a-distributed-system/).*](/5/USL.jpg){#fig:MT_USL width=60%}
