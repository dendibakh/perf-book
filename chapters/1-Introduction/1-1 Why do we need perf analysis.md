...
[^1]: BubbleSort algorithm - [https://en.wikipedia.org/wiki/Bubble_sort](https://en.wikipedia.org/wiki/Bubble_sort)
[^2]: QuickSort algorithm - [https://en.wikipedia.org/wiki/Quicksort](https://en.wikipedia.org/wiki/Quicksort)
[^3]: InsertionSort algorithm - [https://en.wikipedia.org/wiki/Insertion_sort](https://en.wikipedia.org/wiki/Insertion_sort)
[^4]: Typically between 7 and 50 elements
[^7]: This is certainly the case with the order of floating-point operations.
