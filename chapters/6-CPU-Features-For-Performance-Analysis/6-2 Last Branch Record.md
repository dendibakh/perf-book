...
![64-bit Address Layout of LBR MSR. *© Image from [@IntelSDM].*](/4/LBR_ADDR.png){#fig:LbrAddr width=90%}
...
![Probability density function for latency of the basic block that starts at address `0x400618`.](/4/LBR_timing_BB.jpg){#fig:LBR_timing_BB width=90%}
